...
from src.utils.job_input import JobDescription
from src.utils.ollama_client import generate_resume_with_ollama
from src.utils.resume_renderer import render_resume
...
def load_candidate_data() -> dict:
    try:
        with open(
            "private/candidate.yaml", "r", encoding="utf-8"
        ) as candidate_yaml_file:

            candidate_data: dict = yaml.load(
                candidate_yaml_file, Loader=yaml.FullLoader
            )
